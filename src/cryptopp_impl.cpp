...
const CryptoppImpl::byte CryptoppImpl::KEY_FILE[] = { byte('I'), byte('N'), byte('T'), byte('C'), 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00 };
const CryptoppImpl::byte CryptoppImpl::IV_FILE[] = { 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, byte('I'), byte('P'), byte('A'), byte('R'), byte('K') };
